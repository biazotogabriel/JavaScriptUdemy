...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var primeiroDigito = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].criaDigito(cpfSemDigito);
      var segundoDigito = _ValidaCPF_js__WEBPACK_IMPORTED_MODULE_0__["default"].criaDigito(cpfSemDigito + primeiroDigito);
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function valida() {
      ...
      var digito1 = ValidaCPF.criaDigito(this.cpfLimpo.slice(0, -2));
      var digito2 = ValidaCPF.criaDigito(this.cpfLimpo.slice(0, 10));
      var novoCPF = this.cpfLimpo.slice(0, 9) + digito1 + digito2;
      return this.cpfLimpo === novoCPF;
    }
  }], [{
    key: "criaDigito",
    value: function criaDigito(cpfParcial) {
      // geralmente quando a função não utiliza nenhum "this" ela pode ser convertida em static
      var cpfArray = Array.from(cpfParcial);
      var digito = cpfArray.reduce(function (acumulador, valor, indice, array) {
